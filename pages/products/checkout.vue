            ...
            <div class="p-8 lg:overflow-auto lg:h-[calc(100vh-60px)]">
              ...
              <div class="space-y-6 mt-10">
                <div class="grid sm:grid-cols-2 items-start gap-6" v-for="item in itemsStore.all" :key="item.id">
                  ...
                  <div>
                    <h3 class="text-base text-white">{{item.title}}</h3>
                    <ul class="text-xs text-white space-y-3 mt-4">
                      <li class="flex flex-wrap gap-4">Quantity: <span class="ml-auto">{{ item.count }}</span></li>
                      <li class="flex flex-wrap gap-4"> Price each: <span class="ml-auto">${{item.price}}</span></li>
                    </ul>
                </div>             <!--here-->
                </div>
              </div>
